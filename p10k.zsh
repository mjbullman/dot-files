...
# Purpose       : Powerlevel10k theme configuration for Zsh prompt styling.   #
#                                                                             #
# Features:                                                                   #
#   - Custom prompt segments and layout                                       #
#   - Optimized for speed with instant prompt support                         #
#   - Visual Git status integration                                           #
#   - Exit status, command duration, and time display                         #
#   - Left and right prompt customization                                     #
#                                                                             #
# Notes:                                                                      #
#   - This file is loaded by ~/.zshrc if Powerlevel10k is installed           #
#   - Modify only if you understand Powerlevel10k segment syntax              #
#                                                                             #
